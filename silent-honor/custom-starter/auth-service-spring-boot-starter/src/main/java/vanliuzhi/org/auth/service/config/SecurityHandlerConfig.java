    ...
    public WebResponseExceptionTranslator<OAuth2Exception> webResponseExceptionTranslator() {
        return new DefaultWebResponseExceptionTranslator() {
            ...
            public ResponseEntity<OAuth2Exception> translate(Exception e) throws Exception {
                ...
                OAuth2Exception oAuth2Exception1 = Objects.requireNonNull(responseEntity.getBody());
                oAuth2Exception1.addAdditionalInformation("code", oAuth2Exception.getHttpErrorCode() + "");
                oAuth2Exception1.addAdditionalInformation("msg", oAuth2Exception.getMessage());
