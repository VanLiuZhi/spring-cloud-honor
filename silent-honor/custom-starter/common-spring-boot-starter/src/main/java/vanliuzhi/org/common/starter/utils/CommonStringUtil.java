...
package vanliuzhi.org.common.starter.utils;
...
public class CommonStringUtil extends org.apache.commons.lang3.StringUtils{
    ...
    public static boolean checkImgFileType(String fileEnd, String fileType) {
        ...
        if (CommonStringUtil.isEmpty(fileType)) {
            fileType = CommonStringUtil.imgType;
        }
    ...
    public static boolean matchYx(String yx) {
        boolean temp = false;
        if (CommonStringUtil.isNotEmpty(yx)) {
            temp = yx
                    .matches("\\w+([-+.]\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*");
        }
        return temp;
    ...
    public static String mobileEncrypt(String mobile) {
        if (CommonStringUtil.isEmpty(mobile) || (mobile.length() != 11)) {
            return mobile;
        }
    ...
    public static String idEncrypt(String id) {
        if (CommonStringUtil.isEmpty(id) || (id.length() < 8)) {
            return id;
        }
